...
export class CreatePlanFeaturesTable1705153200000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropForeignKey('pln_plan_features', 'FK_pln_plan_features_feature_id');
